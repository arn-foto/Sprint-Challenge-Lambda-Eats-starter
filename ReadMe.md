...
The useRouteMatch hook is used to match the current URL in the same way that a live browser  would. It’s mostly useful for getting access to the match data. 

2. How would you explain form validation to someone who has never programmed before?

Form validation allows an error message to be deployed if the user left any part of the form empty.

3. In 1-2 sentences, define end to end testing. 

End to end testing just ensures that the page/application runs smoothly from beginning to end, to catch any errors.
